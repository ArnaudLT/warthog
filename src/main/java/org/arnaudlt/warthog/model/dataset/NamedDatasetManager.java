    ...
    public void registerNamedDataset(NamedDataset namedDataset) {
        ...
        if (namedDataset == null) {
            ...
            try {
                ...
                namedDataset.setLocalTemporaryViewName(namedDataset.getName());
                namedDataset.getDataset().createTempView(namedDataset.getLocalTemporaryViewName());
            } catch (AnalysisException e) {

                try {

                    final String autoGeneratedTemporaryViewName = getAutoGeneratedTemporaryViewName(namedDataset);
                    namedDataset.setLocalTemporaryViewName(autoGeneratedTemporaryViewName);
                    namedDataset.getDataset().createTempView(namedDataset.getLocalTemporaryViewName());
